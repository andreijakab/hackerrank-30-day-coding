...
void solve(double meal_cost, int tip_percent, int tax_percent)
{
    ...
    // calculate and include tip
    totalCost += meal_cost * tip_percent / 100.0;

    // calculate and include tax
    totalCost += meal_cost * tax_percent / 100.0;

    // display total cost rounded to nearest integer
    printf("%d\n", (int)round(totalCost));
}
